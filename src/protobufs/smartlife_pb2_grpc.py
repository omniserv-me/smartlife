...
class StateUpdateServicer(object):
    """Missing associated documentation comment in .proto file."""
...
def add_StateUpdateServicer_to_server(servicer, server):
    rpc_method_handlers = {
    ...
    generic_handler = grpc.method_handlers_generic_handler(
            'smartlife.StateUpdate', rpc_method_handlers)
    server.add_generic_rpc_handlers((generic_handler,))
    server.add_registered_method_handlers('smartlife.StateUpdate', rpc_method_handlers)
